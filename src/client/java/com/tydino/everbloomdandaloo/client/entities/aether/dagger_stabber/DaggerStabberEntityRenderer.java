...
public class DaggerStabberEntityRenderer extends MobRenderer<DaggerStabberEntity, DaggerStabberRenderState, daggerStabberModel> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(EverbloomDandaloo.MOD_ID, "textures/entity/aether/dagger_stabber.png");

    public DaggerStabberEntityRenderer(EntityRendererProvider.Context context) {
        super(context, new daggerStabberModel(context.bakeLayer(EDAetherModelLoader.DaggerStabber)), 0.4f); // 0.4 shadow radius
    }
