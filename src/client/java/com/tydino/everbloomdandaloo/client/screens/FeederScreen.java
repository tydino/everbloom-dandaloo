...
public class FeederScreen extends AbstractContainerScreen<FeederMenu> {
    private static final Identifier SCREEN_TEXTURE = Identifier.fromNamespaceAndPath(EverbloomDandaloo.MOD_ID,"textures/gui/container/feeder.png");

    public FeederScreen(FeederMenu abstractContainerMenu, Inventory inventory, Component component) {
